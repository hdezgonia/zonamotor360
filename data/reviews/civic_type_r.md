...
Prepárate, porque el FL5 es un coche que no pasa desapercibido. Honda tomó una decisión valiente con este diseño: alejarse del salvajismo visual del FK8 —que parecía diseñado por un adolescente con acceso ilimitado a un taller de tuning— y apostar por algo más maduro, más afilado, más... *serious business*.

El resultado es espectacular. La carrocería es más musculosa y proporcionada. Las entradas de aire delanteras son enormes y funcionales —no de adorno, ojo—, el capó tiene formas que sugieren que debajo hay algo vivo y enfadado, y los pasos de rueda ensanchados abrazan unas llantas de 19 pulgadas que, con los neumáticos Michelin Pilot Sport 4S de serie, ya te están diciendo todo lo que necesitas saber sobre las intenciones de este coche.
...
El FL5 no es un coche pequeño. Es un Civic, al fin y al cabo, y la plataforma ha crecido respecto a generaciones anteriores:

- **Longitud:** 4.595 mm
- **Anchura:** 1.890 mm (con espejos: 2.080 mm)
- **Altura:** 1.405 mm
- **Batalla:** 2.735 mm
- **Peso:** 1.429 kg (en orden de marcha)
- **Vía delantera:** 1.605 mm
- **Vía trasera:** 1.625 mm

Esos 1.429 kg son un número importante. Para lo que ofrece este coche, es una cifra fantástica. Honda ha trabajado mucho en rigidez estructural y distribución de masas, y los resultados se notan nada más tomar la primera curva con ganas.
...
La conectividad es completa: bluetooth multiconexión, carga inalámbrica, y navegación integrada con actualizaciones OTA. No es el sistema más espectacular del segmento, pero funciona bien y no entorpece.
...
Si pensabas que el FL5 iba a ser un coche incómodo en carretera, te equivocas. En modo Comfort, el Civic Type R es un GT civilizado, silencioso y cómodo que devora kilómetros de autopista con una calma desconcertante para lo que esconde debajo.
...
El único pero real: las llantas de 19 pulgadas con perfil bajo son sensibles a los baches agresivos. En ciudades con firme deteriorado, vas a notar cada grieta y cada alcantarilla. Es el precio de vivir con un coche así, y todos los que lo compran lo saben y lo aceptan de buen grado.

## ADAS

Honda ha equipado el FL5 con su suite **Honda Sensing** de serie, que incluye:

- Frenado autónomo de emergencia (CMBS) con detección de peatones y ciclistas
- Control de crucero adaptativo (ACC) con stop & go
- Asistente de mantenimiento de carril (LKAS)
- Alerta de salida de carril (LDW)
- Monitorización de ángulo muerto (BSI)
- Alerta de tráfico cruzado trasero (RCTA)
- Asistente de luces largas automático

El funcionamiento es correcto y fiable. El ACC en autopista mantiene la distancia de forma suave y natural. Lo mejor: cuando activas el modo **+R**, los sistemas ADAS se desconectan parcialmente para no interferir con la conducción dinámica. Honda entiende que hay momentos para la tecnología y momentos para el piloto. Chapó.

## Comportamiento Dinámico

Y aquí llegamos a la razón de ser de este coche.

El FL5 tiene **329 CV y 420 Nm de par** procedentes del motor K20C1 turbo de 2.0 litros. Esos números en tracción delantera suenan a receta para el torque steer y el sufrimiento. Pero Honda ha resuelto el problema de una manera elegante y sofisticada.

El sistema **Dual Axis Strut** en el tren delantero es una pieza de ingeniería magistral que separa las fuerzas de frenada/aceleración de las de dirección, eliminando prácticamente el torque steer. El **diferencial de deslizamiento limitado (LSD) mecánico** en el eje delantero es sencillamente brillante: distribuye el par entre las ruedas con una precisión que permite atacar la salida de las curvas con una agresividad que en teoría no debería ser posible con tracción delantera.

El resultado en carretera es casi sobrenatural. El coche gira, agarra, sale disparado, y en ningún momento te pide que bajes la guardia. La dirección es directa, comunicativa, con un feedback que te habla de lo que está haciendo cada rueda. Y cuando llegas al límite, el FL5 te avisa con tiempo suficiente para corregir.

### Datos que ponen los pelos de punta

- 🏁 **Nürburgring Nordschleife:** 7:44.881 — récord mundial de tracción delantera (julio 2023)
- 🏁 **0-100 km/h:** 5,4 segundos (en condiciones óptimas: 5,1 s)
- 🏁 **0-200 km/h:** alrededor de 17,5 segundos
- 🏁 **Velocidad máxima:** 272 km/h
- 🏁 **100-0 km/h:** ~32 metros

El tiempo en el Ring es, en este segmento, la medida de todas las cosas. Y el FL5 tiene grabado ese récord a fuego como una cicatriz de honor. Ningún hot hatch de tracción delantera ha ido más rápido. Ninguno.

## Confort de Marcha

La suspensión adaptativa del FL5 tiene tres modos:

- **Comfort:** amortiguación sorprendentemente blanda para las prestaciones del coche
- **Sport:** se endurece lo justo para mayor agilidad sin castigar el cuerpo
...
La ficha técnica dice **8,9 L/100km** de consumo mixto WLTP. En la realidad:

| Situación | Consumo |
|---|---|
| Conducción tranquila en carretera | 6,5-7,5 L/100km |
| Conducción mixta urbana/extraurbana | 8-10 L/100km |
| Conducción dinámica activa | 12-15 L/100km |
| Circuito | 25-30+ L/100km |

Son cifras honestas para un 2.0 turbo de 329 CV. Y oye, si tienes 329 CV a tu disposición y te preocupa el consumo, probablemente el FL5 no es tu coche.
...
- Temperatura de aceite y agua
- Presión del turbo
- Carga G longitudinal y lateral
- Cronómetro integrado

Para un coche de serie, es una suite de telemetría impresionante.
...
**La palanca de cambios.** Corta, directa, con un tacto metálico preciso que recuerda que las manuales bien hechas son un instrumento musical.
...
El Honda Civic Type R FL5 es un coche para conductores. No para postureo. No para colecciones. Para conducir.
...
*Nos vemos en la siguiente vuelta. 🔴*
